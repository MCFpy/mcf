...
OUTFILETEXT = INDATA + 'mcf.py.0.2.5'  # File for text output
...
L_CENTERING_REPLICATION = True     # True does not allow multiprocessing in
# the local centering step. Slower, but leads to replicability of the results.
# Default is True.
