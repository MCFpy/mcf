...
class ModifiedCausalForest:
    ...
    cf_chunks_maxsize : Integer (or None), optional
        ...
        If there are 250'000 or less training observations: No splitting. Otherwise:
    ...
    _int_mp_backend : String (or None), optional
        ...
        The default for Windows is ``'joblib'``, else ``'ray'``. If there are more than 250'000
        training observations (that can be used to build the forest), then the default for Windows
        is ``'ray'`` as well.
        Note that in Windows joblib cannot handle more than 62 processes in parallel.
        Internal variable, change default only if you know what you do.
    ...
    gen_tv_cfg : nstance of GenTVCfg dataclass
