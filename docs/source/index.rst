...
To demonstrate how to use **mcf**, we will use the :py:meth:`example_data` function to generate synthetic datasets for training and prediction, and subsequently apply the Modified Causal Forest. 
