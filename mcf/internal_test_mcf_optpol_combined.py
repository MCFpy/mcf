...
This code should only be internally be used to test many mcf and optpolicy
features when use both classes combined (and capture warnings in some of the
                                         external modules).
...
if captured_warnings:
    for warning in captured_warnings:
        print("\nCaptured Warning:", warning.message)
else:
    print('\nNo Warnings recorded.\n')

print('\nEnd of testing.\n\nThanks for testing ModifiedCausalForest and '
      'OptimalPolicy. \n\nYours sincerely\nExperimental OptimalPolicy and MCF'
      ' modules'
