...
def adjust_scores_for_estimation_risk(optp_: 'OptimalPolicy',
    ...
    scores_np = data_df[optp_.var_cfg.polscore_name].to_numpy()
    scores_se_np = data_df[optp_.var_cfg.polscore_se_name].to_numpy()
...
def change_variable_names_estrisk(optp_: 'OptimalPolicy',
    ...
    optp_.var_cfg.polscore_desc_name = remove_duplicates(
        optp_.var_cfg.polscore_desc_name
        )
