...
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `fs_rel_vi_keep_if`       | Defines how the two thresholds (for the outcome regression and the propensity score) are combined. Possible choices are: `"y_relevant"`, `"y_or_d_relevant"`, `"y_and_d_relevant"`. Default: `"y_or_d_relevant"`.                                                                                                              |
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
